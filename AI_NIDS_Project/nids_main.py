...
st.markdown("""
### Project Overview
This system uses Machine Learning (** Randon Forest Algorithm**) to analyze network traffic in real-time.
...
@st.cache_data
def load_data():
    df = pd.read_csv('Excel_All_Features.csv')
    np.random.seed(42)
    n_samples = 5000
...
# Simulating features common in Network Logs
    ...
    'Packet_Length_Mean': np.random.uniform(10,150,n_samples),
...
with col_metrics:
    ...
    if 'model' in st.session_state:
        ...
        # Visualization: Confusion Metrix
